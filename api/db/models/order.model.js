...
// DEFINIR ATRIBUTOS DEL ESQUEMA (id, customerId, createAt, total)
  ...
  NOTA IMPORTANTE
  NOTA IMPORTANTE
  NOTA IMPORTANTE:  NO SE INCLUYE EN LA MIGRACION - DESHABILITADA PORQUE PRESENTA CONFLICTOS
  */
  /*total: {
    ...
    get() {
      ...
      //SINTAXIS: this.Objecto.length - El objeto en este caso es la asociacion la cual funciona como un objeto al usar el comando 'length' si existe algun objeto el indice aumenta a 1
