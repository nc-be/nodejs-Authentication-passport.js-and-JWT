...
// NO SE ESTA EXPORTANDO, SE UTILIZA OTRA ARCHIVO MAS ACTUALIZADO SPARA LOS SERVICIOS DE LOS PRODUCTOS
...
class ProductsService{
  ...
  //  --  pool  --  require('../libs/postgres.pool')
  /*
  ...
  */
  ...
  /* SEQUELIZE GESTIONA LA CONEXION POR SI MISMO */
  }

  /* CLASE 5.15: SE AÑADE COMPORTAMIENTO ASINCRONO A LOS SERIVCIOS
  ...
  */
  //  NO METADATA
    const [data] = await sequelize.query(query); //  SEQUELIZE ENTREGA LA INFORMACION EN UN ARRAY (data o metadata)
    return {data};
  }
